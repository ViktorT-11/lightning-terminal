...
type DevConfig struct {
	...
	UnsafeRemoveDeprecatedKVDBMarkers bool `long:"unsafe-remove-deprecated-kvdb-markers" description:"Remove the kvdb deprecation markers from accounts.db, session.db and rules.db before opening the bbolt backend. Only set this if you know what you are doing."`
}
